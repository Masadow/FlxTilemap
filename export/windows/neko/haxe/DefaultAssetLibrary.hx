...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("images/char_3.png", "images/char_3.png");
		type.set ("images/char_3.png", AssetType.IMAGE);
		path.set ("images/char_4.png", "images/char_4.png");
		...
		path.set ("images/tileset.png", "images/tileset.png");
...
//@:sound("C:/GitRepos/flixel/assets/sounds/beep.ogg") class __ASSET__assets_sounds_beep_ogg extends openfl.media.Sound {}
//@:sound("C:/GitRepos/flixel/assets/sounds/flixel.ogg") class __ASSET__assets_sounds_flixel_ogg extends openfl.media.Sound {}
//
